...
## Multivariate model (BMI)
model3 <- polr(BMI ~ ACUPUNC7+RACE+INCOME7, Hess=TRUE, data=file_cleaned)
summary(model3)
tidy(model3, conf.int=TRUE, exponentiate = TRUE, p.values=TRUE)
brant(model3)


## Multivariate model (appetite)
model4 <- polr(APPETIT7 ~ ACUPUNC7+RACE+INCOME7, Hess=TRUE, data=file_cleaned)
summary(model3)
